// src/app/jobs/manage/[id]/applicants/ApplicantsClient.tsx
'use client';
...
// This component now accepts a simple `jobId` string prop
interface ApplicantsClientProps {
  jobId: string;
}

export default function ApplicantsClient({ jobId }: ApplicantsClientProps) {
